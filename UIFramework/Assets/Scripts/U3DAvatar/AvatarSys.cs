...
public class AvatarSys : MonoBehaviour {
   ...
   public  void BoyAvatar() { 
    ...
    void InstantiateGirl() {
        GameObject go = Instantiate(Resources.Load("Models/FemaleModel")) as GameObject; //加载资源物体
        girlSourceTrans = go.transform;
        go.SetActive(false);
        girlTarget = Instantiate(Resources.Load("Models/FemaleTarget")) as GameObject;        
    ...
    void InstantiateBoy()
    {
        GameObject go = Instantiate(Resources.Load("Models/MaleModel")) as GameObject; //加载资源物体
        boySourceTrans = go.transform;
        go.SetActive(false);
        boyTarget = Instantiate(Resources.Load("Models/MaleTarget")) as GameObject;
    ...
    { //传入部位，编号，从data里边拿取对应的skm 
        ...
        //Debug.LogFormat("part ={0}，num ={1}",part, num);
