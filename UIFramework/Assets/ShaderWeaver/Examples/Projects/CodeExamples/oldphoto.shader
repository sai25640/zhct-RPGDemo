			...
			*/
			...
			float4 frag (v2f i) : COLOR {
				...
				if(uv_dummy2.x>1 || uv_dummy2.y>1)
					discard_dummy2 = true;
				float4 rect_dummy2 =  float4(1,1,1,1);
				...
				v_code1 = OldPhoto(color_dummy2,_code1_rate);
