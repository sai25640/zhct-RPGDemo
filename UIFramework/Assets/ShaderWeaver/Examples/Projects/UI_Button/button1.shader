		...
		pass {   
			...
			*/
			...
			float4 frag (v2f i) : COLOR {
				...
				//====================================
				//============ remap3 ============   
				float2  uv_remap3 = i._uv_STD;
				float uv_remap3A = tex2D(_button1_remap3,uv_remap3).b*tex2D(_button1_remap3,uv_remap3).a;
				float4 color_remap3 = tex2D(_button1_remap3,uv_remap3);    
				if(color_remap3.b >= 0.5)
					color_remap3 = float4(0,color_remap3.gba);


				//====================================
				//============ image3 ============   
				float2  uv_image3 = i._uv_STD;
				uv_image3 = color_remap3.rg;
				float2 center_image3 = float2(0.5,0.5);    
				uv_image3 = uv_image3-center_image3;    
				uv_image3 = uv_image3+fixed2(0,0);    
				uv_image3 = uv_image3+fixed2(-0.25,0)*(_Time.y);    
				uv_image3 = UV_RotateAround(fixed2(0,0),uv_image3,0);    
				uv_image3 = uv_image3/fixed2(1,1);    
				...
				float4 color_image3 = tex2D(_glowBall,uv_image3);    
				if(discard_image3 == true) color_image3 = float4(0,0,0,0);
				color_image3 = color_image3*_Color_image3;
				color_image3 = float4(color_image3.rgb,color_image3.a*color_remap3.a);
				...
				result = result+float4(color_image3.rgb*color_image3.a*1*((1)),color_image3.a*1*((1))*(rootTexColor.a - result.a));
