...
Shader "Shader Weaver/button3"{   
	Properties {   
		...
		_button3_remap4 ("_button3_remap4", 2D) = "white" { }
		...
		pass {   
			...
			*/
			...
			float4 frag (v2f i) : COLOR {
				...
				float uv_remap4A = tex2D(_button3_remap4,uv_remap4).b*tex2D(_button3_remap4,uv_remap4).a;
				float4 color_remap4 = tex2D(_button3_remap4,uv_remap4);    
				...
				float4 color_image3 = tex2D(_ramp,uv_image3);    
