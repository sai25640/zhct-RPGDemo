...
namespace ShaderWeaver
{
	...
	public class SWNodeDummy :SWNodeEffector {
		...
		{
			base.Update ();
			if (SWWindowMain.Instance.data.shaderType == SWShaderType.sprite || SWWindowMain.Instance.data.shaderType == SWShaderType.ui) {
		...
		protected override void DrawNodeWindow (int id)
		{
			...
			else if (SWWindowMain.Instance.data.shaderType == SWShaderType.sprite || SWWindowMain.Instance.data.shaderType == SWShaderType.ui) {
				if (sprite != null) {
