...
namespace ShaderWeaver
{
	...
	public class SWDataNode{
		...
		#region new effect
		public float tst;
		public string tstParam="(1)";
		public float tstRad;
		public string tstRadParam="(1)";
		public Vector2 tstPos;

		public float pinch;
		public string pinchParam="(1)";

		public float fishEye;
		public string fishEyeParam="(1)";
		...
		#endregion
		public SWTexResolution reso = SWTexResolution._512x512;
		public static List<int> resoList
		{
			get{
				return  new List<int> (){ 256, 512, 1024 };
			}
		}
