		...
		pass {   
			...
			*/
			...
			float4 frag (v2f i) : COLOR {
				...
				color_refract1 = Blur(_GrabTexture,uv_refract1,float2( 1*_blurX*0.1 ,1*_blurY*0.1)*rect_refract1.zw,float4(0,0,1,1),false);
