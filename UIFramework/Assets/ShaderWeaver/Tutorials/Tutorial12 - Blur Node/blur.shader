		...
		pass {   
			...
			*/
			...
			float4 frag (v2f i) : COLOR {
				...
				float4 color_ROOT = float4(1,1,1,1);
				color_ROOT = Blur(_MainTex,uv_ROOT,float2( 1*_blurX*0.1 ,1*_blurY*0.1)*rect_ROOT.zw,i.rect_Sprite,true);
