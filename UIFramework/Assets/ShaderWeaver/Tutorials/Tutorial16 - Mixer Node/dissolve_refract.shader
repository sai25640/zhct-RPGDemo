		...
		pass {   
			...
			*/
			...
			float4 frag (v2f i) : COLOR {
				...
				uv_alpha5 = float2(uv_alpha5.x >0 ?(uv_alpha5.x%(1+0)) : (1+0) - abs(uv_alpha5.x)%(1+0), uv_alpha5.y >0 ?(uv_alpha5.y%(1+0)) : (1+0) - abs(uv_alpha5.y)%(1+0));
